...
public class BleedParticle extends SpriteBillboardParticle {
    ...
    protected BleedParticle(ClientWorld level, double xCoord, double yCoord, double zCoord,
        ...
        this.maxAge = 20;
        this.gravityStrength = 999E-4f;
        this.scale = f = this.random.nextBoolean() ? 0.1f : 0.15f;
    ...
    public void tick() {
        ...
        float f = 20 - this.maxAge;
        float g = Math.min(f / 20.0f, 1.0f);
        ...
        this.velocityX += d * (double)0.00025f;
        this.velocityZ += e * (double)0.00025f;
        this.velocityY -= (double)this.gravityStrength * 1.0001f;
        this.field_43369 += this.field_43371 / 20.0f;
        this.prevAngle = this.angle;
        this.angle += this.field_43369 / 20.0f;
        this.move(this.velocityX, this.velocityY, this.velocityZ);
        if (this.onGround || this.maxAge < 19 && (this.velocityX == 0.0 || this.velocityZ == 0.0)) {
            this.markDead();
        }
        if (this.dead) {
            return;
